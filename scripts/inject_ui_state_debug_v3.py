...
from inject_ui_state_debug_v6 import main as inject_ui_state_fixes_v6
from inject_ui_state_debug_v7 import main as inject_ui_state_fixes_v7
...
""",
        ...
        inject_ui_state_fixes_v6()
        inject_ui_state_fixes_v7()
        print("HUD corrective v3 timing injection complete (including v4/v5/v6/v7 current-test corrections).")
        return 0
    except Exception:
